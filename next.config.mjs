...
const nextConfig = {
    images: {
      remotePatterns: [
        ...
        {
          protocol: 'https',
          hostname: 'www.alpharithms.com',
        },
        {
          protocol: 'https',
          hostname: 'www.thearmchaircritic.org',
        },
        {
          protocol: 'https',
